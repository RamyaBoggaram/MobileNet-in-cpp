...
//     cout << "accuracy_all:" << fAccurSum_all << endl;
    ...
    // input an image
 network.Forward("../data/images/img1.jpg");
  network.Forward("../data/images/img2.jpg");

  //network.Forward("/home/keystone/mobilenet-master/data/images/img2.jpg");
   //network.Forward("./data/images/1.jpg");
   //system("pause");
}
